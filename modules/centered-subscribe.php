...
?>
<div class="bg-slate-900 py-4 sm:py-8 fade-in">
  <div class="mx-auto max-w-6xl sm:px-6 lg:px-8">
    <div class="relative isolate overflow-hidden bg-gray-900 px-6 py-16 shadow-2xl sm:rounded-3xl">
      <h2 class="mx-auto max-w-2xl text-center text-3xl font-bold tracking-tight text-white sm:text-4xl mt-0"> <?php echo $title; ?></h2>
      <p class="mx-auto mt-2 max-w-xl text-center text-lg leading-8 text-gray-300"><?php echo $subtitle; ?></p>

...
<footer class="bg-slate-900 py-16" aria-labelledby="footer-heading">
  <h2 id="footer-heading" class="sr-only">Footer</h2>
  <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-0">
    <!-- Nav menu -->
    ...
    <div class="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between">
      <div>
        <h4 class="text-sm font-semibold leading-6 text-slate-200">Subscribe to our newsletter</h4>
        <p class="mt-2 text-sm leading-6 text-gray-600">The latest news, articles, and resources, sent to your inbox
          weekly.</p>
      </div>
    ...
    <div class="mt-8 border-t border-gray-900/10 pt-8 md:flex md:items-center md:justify-between">
      ...
      <p class="mt-8 text-xs leading-5 text-gray-500 md:order-1 md:mt-0">&copy; <?php echo date('Y'); ?> Procuremnent Sciences. All rights
        reserved.</p>
    </div>
  </div>
</footer>
